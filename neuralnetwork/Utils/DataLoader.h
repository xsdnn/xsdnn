...
#ifndef XSDNN_INCLUDE_DATALOADER_H
#define XSDNN_INCLUDE_DATALOADER_H
...
namespace internal
{
    ...
    public:
        ...
        {
            // TODO: Изменить алгоритм подгрузки данных - сделать его более эффективным.
            //  Текущая загрузка - 10.48 сек.
...
{
public:
    Matrix train_data;      ///< тренировачная выборка
    Matrix train_label;     ///< тренировочные лейблы
    Matrix test_data;       ///< тестовая выборка
    Matrix test_label;      ///< тестовые лейблы
...
#endif //XSDNN_INCLUDE_DATALOADER_H
